...
const translations: Record<Language, Record<string, any>> = {
  en: {
    nav: {
      ...
      headerStorage: "Storage Management",
      headerUsers: "User Permissions",
      headerUpdates: "Updates & Releases",
      headerApi: "API Connection",
      storage: "Host Storage Space",
  ...
  de: {
    nav: {
      ...
      headerStorage: "Massenspeicher-Verwaltung",
      headerUsers: "Nutzerberechtigungen",
      headerUpdates: "Updates & Releases",
      headerApi: "API-Anbindung",
      storage: "Host-Speicherplatz (Storage)",
      updates: "Updates & Releases",
  ...
  fr: {
    nav: {
      ...
      headerStorage: "Gestion du Stockage",
      headerUsers: "Permissions Utilisateurs",
      headerUpdates: "Mises à jour & Releases",
      headerApi: "Connexion API",
      storage: "Espace de Stockage",
      updates: "Mises à jour & Releases",
  ...
  es: {
    nav: {
      ...
      headerStorage: "Gestión de Almacenamiento",
      headerUsers: "Permisos de Usuarios",
      headerUpdates: "Actualizaciones & Releases",
      headerApi: "Conexión API",
      storage: "Espacio de Almacenamiento",
      updates: "Actualizaciones & Releases",
      atmosphere: "Fondo:",
      accentColor: "Color:",
